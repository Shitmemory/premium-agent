...
const HeroSection = ({ scrollTargetRef, videoRef, ready }: HeroProps) => {
  ...
  return (
    <section className="h-screen snap-start relative w-full overflow-hidden flex items-start justify-center pt-24 sm:pt-32 md:pt-40 ">
      ...
      <div
        className="absolute bottom-0 left-0 w-full h-[25%] max-sm:h-[45%] z-20 pointer-events-none"
        style={{
          background:
      ...
      <div className="relative z-20 px-4 sm:px-6 md:px-8 py-4 sm:py-6 max-w-3xl w-full text-center max-sm:mt-[50px]">
        {ready && (
          <motion.h1
            ...
            className="text-white font-bold mb-4 text-5xl leading-tight "
          >
      ...
      {/* Chevron */}
      <div className="absolute bottom-32 md:bottom-32 lg:bottom-43 xl:bottom-32 z-30 flex justify-center w-full max-sm:mb-38">
        <button
